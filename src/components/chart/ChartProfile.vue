<template>
    <div class="bg-[#D9D9D9] py-[30px] px-8 rounded-2xl h-full flex flex-col">
        ...
        <div class="inline-flex bg-white rounded-2xl mt-9" style="width: fit-content;">
            <button class="px-10 py-2 text-xl text-white bg-black rounded-2xl">Дедлайны</button>
            <button class="px-10 py-2 text-xl text-black rounded-2xl">Входяшие</button>
        </div>
        ...
        <button @click="$router.push('/listOrders')"
            class="w-full py-3 text-xl font-medium text-black bg-white rounded-lg mt-9">Найти заказы</button>
    </div>
</template>
